...
namespace GoSharpProject.Models
{
    public class OrderCart{
        ...
        {
            // Get the cart
            var cartItem = unitOfWork.CartRepository.Get().ToList<CartRecord>().Single(
        ...
        public List<CartRecord> GetCartItems()
        {
        ...
        public int CreateOrder(Order order)
        {
            ...
            foreach (var item in cartItems)
            {
                ...
                //order.orderItems.Add(item.SiteTemplate);
        ...
        public void MigrateCart(string userName)
        {
            ...
            foreach (CartRecord item in OrderCart)
            {
